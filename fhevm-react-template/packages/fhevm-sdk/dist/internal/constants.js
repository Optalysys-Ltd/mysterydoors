...
export function createTestnetFhevmInstanceConfig(isOptalysysBlue = false) {
...
export function isBlueTestnet(chainId) {
    return chainId === OPTALYSYS_BLUE_CHAIN_ID;
}
export function getDeploymentHostName(customDomainForProduction) {
...
export function buildUrlPath(urlBase, path) {
